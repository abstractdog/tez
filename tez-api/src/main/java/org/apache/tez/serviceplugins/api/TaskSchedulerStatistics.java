...
public class TaskSchedulerStatistics {
  ...
  @VisibleForTesting
  int sumPendingTime = 0;
  @VisibleForTesting
  int averagePendingTime = 0;
  @VisibleForTesting
  int pendingTaskRequestSamples = 0;
  ...
  /**
   * Classes implementing this interface provides basic characteristics about task requests they encapsulate.
   */
