...
public class RootInputInitializerManager {
  ...
  public void runInputInitializers(List<RootInputLeafOutput<InputDescriptor, InputInitializerDescriptor>> inputs, List<TezEvent> pendingInitializerEvents) {
   ...
   * @return
   */
  private List<InitializerWrapper> createInitializerWrappers(List<RootInputLeafOutput<InputDescriptor, InputInitializerDescriptor>> inputs) {
    String current = null;
