...
class TaskSchedulerContextImplWrapper implements TaskSchedulerContext {
  ...
  static class ContainerAllocatedCallable extends TaskSchedulerContextCallbackBase
    ...
    public ContainerAllocatedCallable(TaskSchedulerContext app, Container container) {
      super(app);
      this.container = container;
    }
  ...
  static class ContainerReusedCallable extends TaskSchedulerContextCallbackBase
    ...
    public ContainerReusedCallable(TaskSchedulerContext app, Container container) {
      super(app);
      this.container = container;
    }
